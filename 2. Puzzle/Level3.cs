...
namespace PuzzleGame
{
    public partial class Level3 : Form
    {
        ...
        Random randomizer;
        Game game;
        string path = Path.GetDirectoryName(Application.StartupPath) + "\\lvl3";
        ...
        public Level3()
        {
            ...
            game = new Game(new List<Button>() { n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n15, n16, n17, n18, n19, n20, n21, n22, n23, n24, n25 }, 25);
            prepareMyImages();
        }
        ...
        private void mainTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (game.CheckAllBoard(myPictureBoxes))
            {
                mainTimer.Stop();
                Thread.Sleep(250);
                GameOver go = new GameOver(time, game.Mistakes, "lvl3");
                go.Show();
                this.Close();
            }
